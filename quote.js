...
//BUTTON IDENTIFIERS TO ADD FUNCTIONALITY FOR EVENT LISTENERS
    ...
    //Bootstrap Styling can block certain changes, ex "card default"
    const Step1HeaderCard = document.getElementsByClassName("card-heading"); 
    const Step2HeaderCard = document.getElementsByClassName("carding-heading")
    ...
    BuildingSelection.addEventListener("change", () => {
        ...
        if(BuildingSelection.value == "residential") {
            ...
            Step1HeaderCard[0].style.backgroundColor = "#89CFF0"
            Step1HeaderCard[1].style.backgroundColor = "#89CFF0"
            Step1HeaderCard[2].style.backgroundColor = "#89CFF0"
            Step1HeaderCard[3].style.backgroundColor = "#89CFF0"
            return
        }
        if(BuildingSelection.value == "commercial") {
            console.log(BuildingSelection.value)
            //#FF0000 is "red"
            Step1HeaderCard[0].style.backgroundColor = "#FF0000"
            Step1HeaderCard[1].style.backgroundColor = "#FF0000"
            Step1HeaderCard[2].style.backgroundColor = "#FF0000"
            Step1HeaderCard[3].style.backgroundColor = "#FF0000"
            return
        }
        if(BuildingSelection.value == "industrial") {
            console.log(BuildingSelection.value)
            Step1HeaderCard[0].style.backgroundColor = "gray"
            Step1HeaderCard[1].style.backgroundColor = "gray"
            Step1HeaderCard[2].style.backgroundColor = "gray"
            Step1HeaderCard[3].style.backgroundColor = "gray"
            return
        }
        ...
        // const RequiredFieldValidator, no longer necessary
